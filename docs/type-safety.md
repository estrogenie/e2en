...
e2en is built with strict Luau types. This guide explains how to get full intellisense and type checking in your project.

## The `:: any` Pattern

You'll see this pattern throughout e2en code:
...
The framework returns different modules depending on runtime context:
...
Luau tries to unify both return types at analysis time, which causes type errors. The `:: any` cast bypasses this, and the explicit type annotation (`e2en: Types.e2enServer`) provides the correct type information.
